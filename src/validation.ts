...
export class ConditionUtils {
  ...
  static isBlock(value: any): boolean {
    return (
      BlockTypes.get(value instanceof BlockType ? value.id : value) !==
      undefined
    );
  }
  ...
  static isItem(value: any): boolean {
    return (
      ItemTypes.get(value instanceof ItemType ? value.id : value) !== undefined
    );
  }

  static isEntity(value: any): boolean {
    return (
      EntityTypes.get(value instanceof EntityType ? value.id : value) !==
      undefined
    );
  }
  ...
  static isEffect(value: any): boolean {
    return (
      EffectTypes.get(value instanceof EffectType ? value.getName() : value) !==
      undefined
    );
  }
  ...
  static isEnchant(value: any): boolean {
    return (
      EnchantmentTypes.get(
        value instanceof EnchantmentType ? value.id : value,
      ) !== undefined
    );
  }
  ...
  static isDimension(value: any): boolean {
    return (
      DimensionTypes.get(
        value instanceof DimensionType ? value.typeId : value,
      ) !== undefined
    );
  }
